...
<title>ムーン・バイオセラピー｜短期ダイエット・エステサイズダウン・YOSA｜プライベートサロンカーラ</title>
<meta name="Description" content="東京、表参道のプライベートサロンカーラ。アーユルヴェーダに基づいた体質診断も用いたインドエステで体の中からキレイにさせて頂きます。セルライト除去、脂肪溶解、オイルマッサージなどご希望の方は是非一度ご連絡お待ちしております。短期ダイエット・エステサイズダウン・YOSAなど。ムーン・バイオセラピーのページ。" />
	...
	<div id="Global">
		<div id="GlobalHeader">
			<div id="GlobalIn">
			    ...
			    <div id="Title">
					<h2><img src="komoimg/h2_moon2.jpg" width="860" height="150" alt="メニュー＆プライス -ムーン・バイオセラピー-" title="メニュー＆プライス -ムーン・バイオセラピー-" /></h2>
					<div id="Pannavi">
						<ul>
							<li><a href="index.php">ホーム</a> ＞</li>
							<li>メニュー＆プライス -ムーン・バイオセラピー-</li>
						</ul>
					</div>
			  	</div>
				<div id="Contents">
				  <div id="SubNavigation">
				  		<ul>
							<li><a href="moon_cycle.php">ムーン・バイオセラピー</a></li>
						</ul>
...
<?php  //■■■ 更新用 ここかから =======================================================
	...
	$txt_file = "moon_cycle.txt";	//編集するテキストファイル名
