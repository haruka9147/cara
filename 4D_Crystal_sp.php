...
<?php
	$pageId				= '';
	$subMenu			= 0;
	$metaTitle			= '4Dクリスタルフェイス';
	$metaKeywords		= '目黒,インドエステ,エステサロン,セルライト除去,脂肪溶解,オイルマッサージ,エステティックサロン,メンズサロン,東京';
	$metaDescription	= '東京、表参道のプライベートサロンカーラ。アーユルヴェーダに基づいた体質診断も用いたインドエステで体の中からキレイにさせて頂きます。セルライト除去、脂肪溶解、オイルマッサージなどご希望の方は是非一度ご連絡お待ちしております。短期ダイエット・エステサイズダウン・YOSAなど。4Dクリスタルフェイスのページ。';
...
<?php  //■■■ 更新用 ここかから =======================================================
	...
	$txt_file = "4D_Crystal_sp.txt";	//編集するテキストファイル名
